  ...
  return (
    <ThemeProvider attribute="class">
      <div className="grid grid-cols-12 gap-6 px-5 lg:px-48 mt-14 sm:px-20 md:px-32 sm:mb-0 md:mb-0 mb-10">
        ...
        <div className="col-span-12 bg-white dark:bg-dark-200 dark:text-white lg:col-span-9 rounded-2xl flex flex-col overflow-hidden shadow-custom-light dark:shadow-custom-dark">
          <Navbar />
          <Component {...pageProps} />
        </div>
      </div>
